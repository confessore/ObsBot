...
{
    readonly ILocalStorageAccessService _localStorageAccessService;

    public LiteDBService(
        ILocalStorageAccessService localStorageAccessService)
    {
        _localStorageAccessService = localStorageAccessService;
    }
    ...
    public async Task InvokeAsync(Action<ILiteCollection<TEntity>> action = null)
    {
        try
        {
            var connection = await _localStorageAccessService.FilePathAsync(filename);
